...
public final class CloudInitDiskState extends com.pulumi.resources.ResourceArgs {

    public static final CloudInitDiskState Empty = new CloudInitDiskState();
    ...
    private CloudInitDiskState() {}

    private CloudInitDiskState(CloudInitDiskState $) {
    ...
    public static Builder builder(CloudInitDiskState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CloudInitDiskState();
        }

        public Builder(CloudInitDiskState defaults) {
            $ = new CloudInitDiskState(Objects.requireNonNull(defaults));
        }
        ...
        public CloudInitDiskState build() {
            return $;
        }
    }
